    ...
    *,
    ...
    team = Team(
        ...
        description=(
            ...
            "• Peptide Designer: Peptide design via WAE and LLM engines + GTM/WAE active-zone sampling from HF aggregate peptide landscapes\n"
            ...
            "  - DBAASP/antimicrobial aggregate landscapes → Peptide Designer agent\n"
